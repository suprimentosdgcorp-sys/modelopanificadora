...
// Estado global
var STATE = {
  frei:    {dias:[], desp:[], despCx:[], whats:[], ifood:[], extras:[], despExtra:[]},
  eliseu:  {dias:[], desp:[], despCx:[], whats:[], ifood:[], extras:[], despExtra:[]},
  petronio:{dias:[], desp:[], despCx:[], whats:[], ifood:[], extras:[], despExtra:[]},
...
function carregarTudo(fresh){
  ...
  function processarLoja(l,res){
    ...
    var desp           = (res[1]||[]).concat(despExtrasRows);
    var ifoodRows      = res[2]||[];
    var whatsRows      = res[3]||[];
  ...
  (function(){
    ...
    CHARTS['cv-lucr']=new Chart(el('cv-lucr'),{
      ...
      options:{responsive:true,maintainAspectRatio:false,
        ...
        scales:{
          x:{ticks:{color:'#9B7A3A',font:{size:9}},grid:{display:false}},
          y:{beginAtZero:true,ticks:{color:'#9B7A3A',font:{size:9},callback:function(v){return v.toFixed(0)+' %';}},
